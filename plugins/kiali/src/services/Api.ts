...
export class KialiApiClient implements KialiApi {
  ...
  async getOverview(
    ...
    return this.getAPI(KialiEndpoints.getOverview, requestBody).then( resp => {
        const typeFunc = switchType(overviewType, AppHealth, ServiceHealth, WorkloadHealth)
